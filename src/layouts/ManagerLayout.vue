<template>
  <div :class="['flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light']">
    ...
    <!-- Sidebar -->
    <aside class="flex-shrink-0 hidden w-64 bg-black border-r dark:border-primary-darker dark:bg-darker md:block">
      <div class="flex flex-col h-full">
        <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
          
          <!-- Dashboards links -->
          <div>
            <a class="flex items-center justify-center p-2 text-white transition-colors rounded-md dark:text-light hover:bg-primary-100 dark:hover:bg-primary" style="font-style: italic;font-weight: bold;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
              {{ truncatedUserName }}
            </a>
            ...
            >
              ...
              <span class="ml-2 text-sm text-white">Dashboard</span>
            </a>
          </div>
    ...
    <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
      <header class="relative bg-white dark:bg-darker sticky top-0 z-50">
        <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
          ...
          <div class="flex">
            ...
            &nbsp;&nbsp;<router-link to="#" class="inline-block mt-1 text-2xl font-bold tracking-wider bg-gradient-to-b from-green-900 to-gray-800 bg-clip-text text-transparent" style="font-family: sa;">Predictive Maintenance Using IoT and Machine Learning in the Milk 
      ...
      <main class="flex-grow">
            <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
              ...
              <a
                v-if="$route.path === '/Manager/fetch_dataset'"
    ...
    <nav 
      ...
      class="absolute top-16 inset-x-4 md:hidden z-50 flex flex-col items-center p-4 bg-teal-900 rounded-md shadow-lg dark:bg-darker"
      ref="dropdownMobileMainMenu"
    >
      <div class="space-y-2">
        <!-- Dashboards Link -->
         <a class="flex items-center justify-center p-2 text-white transition-colors rounded-md dark:text-light hover:bg-primary-100 dark:hover:bg-primary"  style="font-weight: bold;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
          {{ truncatedUserName }}
         </a>
         <a
          href="/Manager/dashboard"
    ...
    <div ref="modal" class="modal">
      <div class="modal-content text-center">
        <h3 class="mt-2">Confirm Logout&nbsp;:&nbsp;<i class="fa fa-lock"></i></h3>
