        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <button
                type="submit"
                class="w-full px-4 mt-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-purple-500 focus:outline-none"
              ...
              <button
                type="submit"
                class="w-full px-4 mt-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 focus:outline-none"
                @click="recoverPassword"
                v-else
              >
              ...
              <div id="forgot_pswd">
                <p class="mt-4">
                  <router-link
                    class="text-sm font-medium text-blue-600 dark:text-purple-400 hover:underline"
                    to="/login"
                  >
