    ...
    <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
      <div class="flex flex-col overflow-y-auto md:flex-row">
        ...
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          <div class="w-full">
            ...
            <form @submit.prevent="handleLogin">
              ...
              <button v-if="loading" type="submit" class="w-full px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 focus:outline-none">
                <i class="fa fa-spinner fa-spin"></i>&nbsp;Logging . . .
              </button>

              <button v-else type="submit" class="w-full px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 focus:outline-none">
            ...
            <div id="forgot_pswd">
              <p class="mt-4">
                <router-link class="text-sm font-medium text-blue-600 dark:text-purple-400 hover:underline" to="/forgot_password">
        ...
        <div class="h-32 md:h-auto md:w-1/2">
          <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="../../assets/Homepage_images/sobre.jpg" alt="Office" />
          <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="../../assets/Homepage_images/sobre.jpg" alt="Office" />
        </div>
      </div>
    </div>
  </div>
